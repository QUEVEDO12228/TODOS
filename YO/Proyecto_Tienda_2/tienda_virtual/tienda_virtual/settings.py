...
SECRET_KEY = 'django-insecure-^#1h2*u3wmx6wi$cl*v%9p8v7g8do2t@6@qd_g#&i2ad#&7-4l'
...
INSTALLED_APPS = [
    ...
    #se agregan las aplicaciones creadas
    'core',
    'usuarios',
    'productos',
    'carrito',
...
TEMPLATES = [
    {
        ...
        #configuración de forma global de los templates
...
#configuración para la utilización de imagenes en el proyecto
MEDIA_URL = '/media/'
